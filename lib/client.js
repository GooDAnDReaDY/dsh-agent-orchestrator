...
.dso-banner { box-sizing: border-box; width: 100%; display: flex; align-items: center; justify-content: space-between; background: var(--dsw-alias-bg-layer-3); border: 1px solid var(--dsw-alias-border-l2); border-radius: 12px; padding: 7px 14px; font-family: inherit; font-size: 13px; color: var(--dsw-alias-label-primary); user-select: none; box-shadow: 0 1px 4px rgba(0, 0, 0, 0.08); transition: all 0.15s ease; gap: 8px; }
.dso-banner:hover { border-color: var(--dsw-alias-label-tertiary); }
.dso-banner.completed { border-color: var(--dsw-alias-state-success-primary, #10b981); }
.dso-banner.failed { border-color: var(--dsw-alias-state-error-primary, #ef4444); }
...
.dso-banner-badge.dso-badge-running { border-color: rgba(99, 102, 241, 0.4); color: #818cf8; background: rgba(99, 102, 241, 0.12); }
.dso-banner-badge.dso-badge-ok { border-color: rgba(16, 185, 129, 0.4); color: #10b981; background: rgba(16, 185, 129, 0.12); }
.dso-banner-badge.dso-badge-err { border-color: rgba(239, 68, 68, 0.4); color: #ef4444; background: rgba(239, 68, 68, 0.12); }
...
.dso-dock-btn:hover { background: var(--dsw-alias-bg-layer-4, rgba(255,255,255,0.08)); border-color: var(--dsw-alias-label-tertiary); }
.dso-dock-btn.close { padding: 3px 6px; color: var(--dsw-alias-label-secondary); }
.dso-dock-btn.close:hover { color: #ef4444; }
...
.dso-pulse-dot { width: 7px; height: 7px; border-radius: 50%; background: #6366f1; animation: dso-pulse 1.6s infinite ease-in-out; }
@keyframes dso-pulse { 0%, 100% { opacity: 1; transform: scale(1); } 50% { opacity: 0.4; transform: scale(0.8); } }
.dso-modal-backdrop { position: fixed; inset: 0; background: rgba(0,0,0,0.65); z-index: 99999; display: flex; align-items: center; justify-content: center; backdrop-filter: blur(2px); }
.dso-modal { background: var(--dsw-alias-bg-layer-3, #1e1e24); border: 1px solid var(--dsw-alias-border-l2, #333); border-radius: 14px; width: 92%; max-width: 580px; max-height: 85vh; display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 12px 32px rgba(0,0,0,0.4); font-family: inherit; color: var(--dsw-alias-label-primary, #fff); }
...
.dso-stage-item { border: 1px solid var(--dsw-alias-border-l2); border-radius: 8px; padding: 10px 12px; background: rgba(255,255,255,0.02); display: flex; flex-direction: column; gap: 6px; }
.dso-stage-head { display: flex; align-items: center; justify-content: space-between; font-size: 13px; font-weight: 500; }
.dso-stage-log { font-family: monospace; font-size: 11px; background: rgba(0,0,0,0.3); padding: 8px; border-radius: 6px; max-height: 120px; overflow-y: auto; white-space: pre-wrap; color: var(--dsw-alias-label-secondary); }
/* Issue #3: Subagent Header Utilities Chip */
.dso-subagent-header-chip { display: inline-flex; align-items: center; gap: 6px; background: var(--dsw-alias-bg-layer-2, rgba(255,255,255,0.06)); border: 1px solid var(--dsw-alias-border-l2, rgba(255,255,255,0.12)); border-radius: 999px; padding: 3px 10px; font-size: 12px; font-weight: 500; color: var(--dsw-alias-label-primary); }
.dso-chip-icon { font-size: 13px; }
.dso-chip-role { font-weight: 600; color: #818cf8; }
.dso-chip-sep { color: var(--dsw-alias-label-tertiary); }
.dso-chip-model { font-size: 11px; color: var(--dsw-alias-label-secondary); }
.dso-chip-parent-link { color: var(--dsw-alias-link, #38bdf8); text-decoration: none; font-size: 11px; padding: 1px 6px; background: rgba(56, 189, 248, 0.1); border-radius: 4px; transition: all 0.15s ease; cursor: pointer; }
.dso-chip-parent-link:hover { background: rgba(56, 189, 248, 0.2); text-decoration: underline; }

/* Issue #5: Specialist Toolview Card */
.dso-toolview-card { background: var(--dsw-alias-bg-layer-3, #18181b); border: 1px solid var(--dsw-alias-border-l2, #27272a); border-radius: 10px; padding: 12px 14px; margin: 6px 0; display: flex; flex-direction: column; gap: 10px; font-family: inherit; font-size: 13px; color: var(--dsw-alias-label-primary, #f4f4f5); box-shadow: 0 4px 14px rgba(0,0,0,0.2); }
...
.dso-toolview-status-pill.ok { background: rgba(16, 185, 129, 0.15); color: #10b981; border: 1px solid rgba(16, 185, 129, 0.3); }
.dso-toolview-status-pill.running { background: rgba(99, 102, 241, 0.15); color: #818cf8; border: 1px solid rgba(99, 102, 241, 0.3); }
.dso-toolview-status-pill.err { background: rgba(239, 68, 68, 0.15); color: #ef4444; border: 1px solid rgba(239, 68, 68, 0.3); }
.dso-toolview-tooldiff { background: rgba(0,0,0,0.25); border: 1px solid var(--dsw-alias-border-l1); border-radius: 8px; padding: 8px 10px; display: flex; flex-direction: column; gap: 6px; }
...
.dso-pill.allow { background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.25); }
.dso-pill.blocked { background: rgba(239, 68, 68, 0.12); color: #f87171; text-decoration: line-through; border: 1px solid rgba(239, 68, 68, 0.25); }
.dso-pill.denied { background: rgba(245, 158, 11, 0.12); color: #fbbf24; border: 1px solid rgba(245, 158, 11, 0.25); }
.dso-toolview-deliverable { background: var(--dsw-alias-bg-layer-2, rgba(255,255,255,0.02)); border-radius: 6px; padding: 10px 12px; font-size: 13px; line-height: 1.5; max-height: 280px; overflow-y: auto; white-space: pre-wrap; color: var(--dsw-alias-label-primary); border: 1px solid var(--dsw-alias-border-l1); }
.dso-toolview-callout { padding: 6px 10px; border-radius: 6px; font-size: 12px; font-weight: 500; background: rgba(16, 185, 129, 0.08); border: 1px solid rgba(16, 185, 129, 0.25); color: #10b981; display: flex; align-items: center; gap: 6px; }
...
`
    ...
    function KanbanTab({ config = {}, onConfigChange }) {
      ...
      return h('div', { className: 'dso-panel' },
        ...
        h('div', { className: 'dso-agent-row' },
          ...
          h('div', { style: { marginTop: 8, padding: '8px 12px', background: 'rgba(255, 255, 255, 0.02)', borderRadius: 7, fontSize: 12, color: 'var(--dsw-alias-label-secondary)' } },
      ...
      return h('div', { className: 'dso-modal-backdrop', onClick: onClose },
        h('div', { className: 'dso-modal', onClick: (e) => e.stopPropagation() },
          ...
          h('div', { className: 'dso-modal-body' },
            ...
            error ? h('div', { style: { color: '#ef4444', fontSize: 12 } }, error) : null
          ),
      ...
      return h('div', { className: 'dso-toolview-card' },
        h('div', { className: 'dso-toolview-header' },
          h('div', { className: 'dso-toolview-badge' },
            ...
            h('span', { className: 'dso-toolview-model-tag' }, modelName)
          ),
        ...
        !isRunning && !isErr ? h('div', { className: 'dso-toolview-callout' },
          h('span', null, '🟢 Результат работы субагента принят оркестратором')
        ) : null
      )
    }
    ...
    function HeaderOrchestratorWidget(props) {
      ...
      if (subagentMeta || parentId) {
        ...
        return h('div', { className: 'dso-subagent-header-chip' },
          ...
          model ? h('span', { className: 'dso-chip-model' }, model) : null,
          parentId ? h('a', {
    ...
    module.exports.apply = function apply(ctx) {
      ...
      // 2. Direct fallback: Sidebar section in settings.section (so settings are always reachable in Settings sidebar)
      registerSlotSafe(
        'settings.section',
        {
