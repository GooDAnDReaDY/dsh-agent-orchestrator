...
export function buildStaticBaseAnchor(config = {}) {
  ...
  return [
    ...
    '',
    '## 2. ENGINEERING EXECUTION STANDARDS',
    ...
    '',
    '## 3. MULTI-AGENT DAG COORDINATION CONTRACT',
    '- Directed Acyclic Graph: Tasks execute in topological order with strict dependency resolution.',
    ...
    'This system prefix is intentionally structured and token-padded to optimize KV-cache reuse.',
