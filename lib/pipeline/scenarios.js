  ...
  return {
    ...
    [ROLE_IDS.QA_TESTS]: {
      ...
      systemPrompt: [
        ...
        'Strict Boundaries: Deliver exhaustive verification suites and pinpoint edge-case defects.',
      ].join(' '),
      temperature: 0.2,
      maxTokens: 4096,
    },
    [ROLE_IDS.BUGFIX]: {
      ...
      systemPrompt: [
        ...
        'Strict Boundaries: Minimal blast radius, laser-targeted code modifications.',
      ].join(' '),
      temperature: 0.1,
      maxTokens: 4096,
    },
    ...
    [ROLE_IDS.REFACTORING]: {
      ...
      systemPrompt: [
        ...
        'Strict Boundaries: Maintain full backward compatibility and zero regressions.',
      ].join(' '),
      temperature: 0.2,
      maxTokens: 8192,
    },
    [ROLE_IDS.RESEARCH]: {
      ...
      systemPrompt: [
        ...
        'Strict Boundaries: Deliver clear findings, benchmarks, and actionable recommendations.',
      ].join(' '),
      temperature: 0.3,
      maxTokens: 4096,
    },
