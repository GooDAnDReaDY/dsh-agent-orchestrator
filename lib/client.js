      ...
      return h('div', { className: 'dso-panel' },
        ...
        h('div', { className: 'dso-agent-list' },
          roleList.map((role) => {
            ...
            return h('div', { key: role.id, className: 'dso-agent-row' },
              h('div', { className: 'dso-agent-header' },
                h('div', null,
                  ...
                  h('span', { className: `dso-model-chip ${modelChip.badgeClass}`, title: modelChip.tooltip, style: { marginLeft: 8 } }, modelChip.text)
                ),
